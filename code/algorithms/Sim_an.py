...
class SimulatedAnnealing1(Algorithm):
...
class SimulatedAnnealing2(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
...
class SimulatedAnnealing3(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
...
class SimulatedAnnealing4(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
...
class SimulatedAnnealing5(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
...
class SimulatedAnnealing6(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
...
class SimulatedAnnealing7(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
...
class SimulatedAnnealing8(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
        ...
        # Starting values 
        protein = self.protein
        initial_temp: int = 500
        cooling_rate: int = 0.91
        min_temp: int = 5
        times: int = 4
        iterations_limit = self.max_iterations
...
class SimulatedAnnealing9(Algorithm):
    def run(self, store_step_stability: bool=False) -> Protein:
        """
        Starts with a randomly folded protein that will try to apply random folds.
        Each fold that improves the stability score is accepted for the next iteration.
